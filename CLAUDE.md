...
| `green` | Voicing con 5ta (lidio) — derivable de que `degrees` contiene `5` | estructural |
...
| **Lidio** | **141** | leído (135/141) de p06+p07 (PDF con verde), best-effort → `data/draft/p06-lidio.json`. Todo voicing lleva `#11`; verde = tiene 5ta (derivado). Sistemas densos = menor confianza en voces medias. Faltan ~6. |
| Locrio | (pendiente) | — |
